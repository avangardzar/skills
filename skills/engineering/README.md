...
- **[grill-one-by-one](./grill-one-by-one/SKILL.md)**: The same docs-writing grilling session as `grill-with-docs`, except it asks one question at a time and records each answer before the next one.
